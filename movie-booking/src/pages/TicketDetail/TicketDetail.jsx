  ...
  return (
    <><Header />
      <div className="bg-black h-screen flex flex-col items-center p-4 text-white relative overflow-hidden block">
        ...
        <button
          onClick={() => navigate(-1)}
          className="absolute top-4 left-12 w-[34px] h-[34px] bg-[#FF5524] text-white rounded-full flex items-center justify-center shadow-lg hover:bg-[#FF5524] transition bloack md:hidden"
        >
        ...
        <div className="flex-1 flex flex-col items-center w-full overflow-y-auto h-full">
          {tickets.map((ticket, index) => {
            ...
            return (
              <div key={index} className="bg-[#FF5524] rounded-3xl w-[85%] max-w-[350px] h-[90%] flex flex-col items-center relative shadow-2xl pb-4 mt-4">
                ...
                <div className="w-full h-[10vh] bg-[#FF5524] text-center py-4 border-t-2 border-dashed border-black relative">
                  ...
                  <div className="flex items-center gap-10 w-full justify-center mt-3">
                    <div className="flex flex-col items-center text-white gap-2">
                      <p className="font-bold text-3xl leading-none">{formattedDate.split(",")[1]}</p>
